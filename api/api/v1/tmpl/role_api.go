...
func (a *RoleApi) Config(ctx *gin.Context) {
	l := new(srv.RoleSrv)
	resp, err := l.Config()
	if err != nil {
...
func (a *RoleApi) List(ctx *gin.Context) {
...
func (a *RoleApi) Create(ctx *gin.Context) {
...
func (a *RoleApi) Update(ctx *gin.Context) {
...
func (a *RoleApi) Delete(ctx *gin.Context) {
