        ...
        >
            ...
            >
                <template slot="header" slot-scope="scope">
                    <div style="text-align: right; margin: -4px 10px -4px 0">
                        目标状态
                    </div>
            ...
            >
                ...
                <template slot-scope="scope">
                    ...
                    <el-checkbox
                        v-else
                        v-model="
                            scope.row[`row_${scope.row.id}_${col.id}`].checked
                        "
                        @change="(val) => checkboxChange(val, scope.row, col)"
                    ></el-checkbox>
                    <img
                        v-show="
                            scope.row[`row_${scope.row.id}_${col.id}`].checked
