<template>
    <div>
        ...
        >
                ...
                <div class="filter-list">
                    ...
                    >
                        ...
                        <el-select
                            ...
                            placeholder="请选择字段"
                            @change="
                                (val) => filterFieldChange(val, filterIndex)
                            "
                        >
                            <el-option
            ...
            <!-- :class="{ editing: editing || filterGroup.length }" -->
            <span
                slot="reference"
                class="btn-icon"
...
export default {
    ...
    methods: {
        ...
        checkFilter() {
            // 检查是否每条filter都有值
            let res = false;
            this.filterGroup.forEach((filterItem) => {
                if (
                    !filterItem.field_key ||
                    !filterItem.op ||
                    !filterItem.value
        ...
        saveFilter() {
            ...
            this.$emit("save-filter", this.filterParams, this.andOr, order);
        },
        deleteItem(index) {
