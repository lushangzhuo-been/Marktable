...
import htmlTags from "./config/html_tags";
import fontSizeTable from "./config/font_size_table";
import otherConfig from "./config/other_config";
...
export default {
    ...
    watch: {
        ...
        html(val) {
            if (
                this.html &&
                (this.html.startsWith("https://") ||
                    this.html.startsWith("http://"))
            ) {
                this.loadUrl(val);
            } else {
                // this.outContent = '';
