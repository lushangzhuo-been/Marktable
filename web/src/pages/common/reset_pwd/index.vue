    ...
    <div class="reset-page">
        <div class="reset-box">
                ...
                <el-form-item prop="email">
                    ...
                    >
                        ...
                        <el-button
                            ...
                            size="small"
                            :disabled="
                                second !== totalSecond || !resetPwdForm.username
                            "
                            @click="getValideCode"
                            >{{
                                second === totalSecond
                    ...
                    >
                        ...
                        >
                            <el-image
                                ...
                                "
                                fit="scale-down"
                                @click="changeEye(resetPwdType, 'resetPwdType')"
                            />
                        </el-input>
                    </el-popover>
                </el-form-item>
            ...
            <div class="click-to-login">
                ...
                <span class="reg" @click="onbtnClick">直接登录</span>
            </div>
        </div>
    </div>
</template>
...
export default {
    data() {
        ...
        return {
            ...
            index4: false,
            title: "重置",
            resetPwdType: "password",
            resetCheckPwdType: "password",
            resetPwdForm: {
                username: "",
                code: "",
                pwd: "",
    ...
    methods: {
        getValideCode() {
            api.getCodeForResetPwd({
                username: this.resetPwdForm.username
            }).then((res) => {
                if (res && res.resultCode === 200) {
                    this.$message({
                        showClose: true,
                        message: "验证码已发送至注册邮箱中，请查收！",
                        type: "success"
                    });
        ...
        reset() {
            this.$refs.resetPwdForm.validate((flag) => {
                if (flag) {
                    if (
                        this.index1 &&
                        this.index2 &&
                        ...
                        let params = {
                            username: this.resetPwdForm.username,
                            password: this.resetPwdForm.pwd,
